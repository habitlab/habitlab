  ...
  window.demos = [
    ...
    {name: 'objects', title: 'Object Items'},
    {name: 'item-template'},
    {name: 'filtering', title: 'Remote and Custom Filtering'},
    {name: 'advanced'}
  ];
    ...
    var users = [{
      ...
      'email': 'laroê.dacruz@example.com',
      'picture': {
      ...
      'email': 'رادین.سلطانینژاد@example.com',
      'picture': {
      ...
      'email': 'آنیتا.رضاییان@example.com',
      'picture': {
      ...
      'email': 'ülkü.duygulu@example.com',
      'picture': {
        'large': 'https://randomuser.me/api/portraits/women/28.jpg',
        'medium': 'https://randomuser.me/api/portraits/med/women/28.jpg',
        'thumbnail': 'https://randomuser.me/api/portraits/thumb/women/28.jpg'
      ...
      'email': 'honória.nunes@example.com',
      'picture': {
      ...
      'email': 'mirco.aragão@example.com',
      'picture': {

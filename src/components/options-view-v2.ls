...
polymer_ext {
  ...
  compute_sidebar_items: (enabled_goal_info_list) ->
    ...
    return [{name: 'Overview', icon: default_icon}, {name: 'Settings', icon: gear_icon}].concat [{name: x.sitename_printable, icon: default_icon} for x in enabled_goal_info_list]

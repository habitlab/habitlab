...
(function(){
  var livescript, gulp, gulpChanged, gulpUtil, gulpPrint, gulpLivescript, gulpYaml, gulpEslint, gulpHeader, path, fs, vinylNamed, webpack, gulpVulcanize, gulpCrisper, del, deepcopy, jsYaml, mkdirp, glob, bestzip, chromeWebStoreItemProperty, livereload, semver, deepmerge, is_debug_build, BabiliPlugin, UglifyJsPlugin, HabitLabComponentRenamePlugin, fse, webpackStream, prelude, gen_deps, function_signatures, webpack_config_frontend, webpack_config_backend, lspattern, lspattern_srcgen, enabled_intervention_list, yamlpattern_manifest, yamlpattern_base, yamlpattern, eslintpattern, jspattern_srcgen, htmlpattern_srcgen, intervention_copypattern, copypattern, copyrootpattern, webpack_pattern, webpack_pattern_content_scripts, webpack_vulcanize_pattern, vulcanize_html_pattern, vulcanize_html_output_pattern, vulcanize_watch_pattern, eslint_config, empty_or_updated, fromcwd, run_gulp_webpack, with_created_object, webpack_config_watch, webpack_config_nowatch, webpack_config_watch_content_scripts, webpack_config_nowatch_content_scripts, webpack_config_nosrcmap_watch, webpack_config_nosrcmap_nowatch, webpack_config_prod_nowatch, webpack_config_prod_nowatch_content_scripts, copy_file_patterns, copy_file_pattern, extra_folders, mkzip_function, get_latest_published_version, slice$ = [].slice;
  ...
  webpack_config_prod_nowatch = with_created_object(webpack_config_backend, function(o){
    ...
    return o.plugins.push(new BabiliPlugin({}, {
      comments: false
    }));
  });

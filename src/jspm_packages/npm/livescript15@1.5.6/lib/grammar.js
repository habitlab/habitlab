...
bnf = {
  Chain: [
    ...
    }), o('[ FROM Expression TO Expression ]', function(){
    ...
    }), o('[ FROM Expression TO Expression BY Expression ]', function(){
      return Chain(L(2, 7, new For({
        from: $3,
        op: $4,
        to: $5,
        step: $7,
  ...
  SplatChain: [o('... Chain', function(){
    return Splat($2.unwrap());
  })],
  Expression: [
    o('Chain CLONEPORT Expression', function(){
      ...
      return Unary($1, Splat($3.unwrap()));
    }), o('SplatChain CREMENT', function(){
      return Unary($2, $1, true);
    }), o('UNARY ASSIGN     Chain', function(){
      return Assign($3.unwrap(), [$1], L(2, Box($2)));
    }), o('+-    ASSIGN     Chain', ditto), o('CLONE ASSIGN     Chain', ditto), o('UNARY ASSIGN ... Chain', function(){
      return Assign(Splat($4.unwrap()), [$1], L(2, Box($2)));
      ...
      return Unary($1, Splat($3));
    }), o('+-    ... Expression', ditto, {
      prec: 'UNARY'
    }), o('CLONE ... Expression', ditto, {
      prec: 'UNARY'
    }), o('UNARY ... INDENT ArgList OptComma DEDENT', function(){
      return Unary($1, Splat(Arr($4)));
    }), o('UNARY INDENT ArgList OptComma DEDENT', function(){
      ...
      return L(1, 2, If($2, $3, $1 === 'unless')).addElse($4);
      ...
      return new Try($2, void 8, L(3, $4));
    }), o('TRY Block CATCH Block     FINALLY Block', function(){
      return new Try($2, void 8, L(3, $4), L(5, $6));
    }), o('TRY Block CATCH Arg Block', function(){
      return new Try($2, $4, L(3, 4, $5));
    }), o('TRY Block CATCH Arg Block FINALLY Block', function(){
      return new Try($2, $4, L(3, 4, $5), L(6, $7));
    }), o('TRY Block                 FINALLY Block', function(){
      return new Try($2, void 8, void 8, L(3, $4));
  ...
  KeyValue: [
    o('Key', function(){
      ...
      return Prop($3, Chain($1.maybeVar(), [L(2, 3, Index($3, $2))]));
  ...
  Parenthetical: [o('( Body )', function(){
    return Parens($2.chomp().unwrap(), false, $1 === '"', L(1, {}), L(3, {}));
  })],
  Body: [
  ...
  LoopHead: [
    ...
    }), o('FOR FROM Expression TO Expression BY Expression', function(){
      return new For({
        kind: $1,
        from: $3,
        op: $4,
    ...
    }), o('FOR FROM Expression TO Expression BY Expression CASE Expression', function(){
      return new For({
        kind: $1,
        from: $3,
        op: $4,
    ...
    }), o('FOR FROM Expression TO Expression CASE Expression BY Expression', function(){
      return new For({
        kind: $1,
        from: $3,
        op: $4,
  ...
  Cases: [
    o('CASE Exprs Block', function(){
      return [L(1, 2, new Case($2, $3))];
    }), o('Cases CASE Exprs Block', function(){
      return $1.concat(L(2, 3, new Case($3, $4)));
    })
  ],
  OptExtends: [

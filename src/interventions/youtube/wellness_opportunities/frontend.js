...
require_component('wellness-suggestions')
...
function removeSidebar(sidebar_selector) {
  ...
  let habitlab_inserted_div = $('<div style="width: 100%; height: 100%; text-align: center">')
  let habitlab_Wellness = $('<wellness-suggestions> </wellness-suggestions>')
  habitlab_inserted_div.append(habitlab_Wellness);

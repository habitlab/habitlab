    ...
    $.fn.pagepiling = function (custom) {
        ...
        */
        PP.setMouseWheelScrolling = function (value){
            console.log('pagepiling setMousewheelScrolling called with value ' + value)
            if(value){
        ...
        */
        PP.setAllowScrolling = function (value){
            console.log('pagepiling setAllowScrolling called with value ' + value)
            if(value){
        ...
        */
        PP.setKeyboardScrolling = function (value){
            console.log('pagepiling setKeyboardScrolling called with value ' + value)

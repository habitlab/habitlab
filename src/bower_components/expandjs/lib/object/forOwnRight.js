...
(function () {
    ...
    /**
     * This method is like `XP.forOwn` except that it iterates over properties of `object` in the opposite order.
     *
     * ```js
     * function Foo() {
     *     this.a = 1;
     ...
     * Foo.prototype.c = 3;
     *
     * XP.forOwnRight(new Foo, function(value, key) { console.log(key); });
     ...
     */
    module.exports = function forOwnRight(object, iteratee, thisArg) {
